      ...
      data: {
        ...
        columns: {
          create: [
            ...
            { field: 'accountName', label: 'Account Name', visible: true, order: 4, },
            { field: 'accountSite', label: 'Account Site', visible: true, order: 5, },
            { field: 'parentAccountId', label: 'Parent Account', visible: false, order: 6, },
            { field: 'accountNumber', label: 'Account Number', visible: true, order: 7, },
            { field: 'accountType', label: 'Account Type', visible: true, order: 8 },
            { field: 'industry', label: 'Industry', visible: true, order: 9 },
            { field: 'annualRevenue', label: 'Annual Revenue', visible: false, order: 10, },
            { field: 'rating', label: 'Rating', visible: false, order: 11 },
            { field: 'phone', label: 'Phone', visible: true, order: 12 },
            { field: 'fax', label: 'Fax', visible: false, order: 13 },
            { field: 'website', label: 'Website', visible: false, order: 14 },
            { field: 'tickerSymbol', label: 'Ticker Symbol', visible: false, order: 15, },
            { field: 'ownership', label: 'Ownership', visible: false, order: 16, },
            { field: 'employees', label: 'Employees', visible: false, order: 17, },
            { field: 'sicCode', label: 'SIC Code', visible: false, order: 18 },
            { field: 'billingAddress.country', label: 'Billing Country', visible: false, order: 19 },
            { field: 'billingAddress.city', label: 'Billing City', visible: true, order: 20, },
            { field: 'billingAddress.stateProvince', label: 'Billing State', visible: false, order: 21, },
            { field: 'billingAddress.postalCode', label: 'Billing Postal Code', visible: false, order: 22, },
            { field: 'billingAddress.streetAddress', label: 'Billing Address', visible: false, order: 23, },
            { field: 'shippingAddress.country', label: 'Shipping Country', visible: false, order: 24 },
            { field: 'shippingAddress.city', label: 'Shipping City', visible: false, order: 25 },
            { field: 'shippingAddress.stateProvince', label: 'Shipping State', visible: false, order: 26 },
            { field: 'shippingAddress.postalCode', label: 'Shipping Postal Code', visible: false, order: 27 },
            { field: 'shippingAddress.streetAddress', label: 'Shipping Address', visible: false, order: 28 },
            { field: 'description', label: 'Description', visible: false, order: 29, },
            { field: 'createdAt', label: 'Created At', visible: false, order: 30 },
            { field: 'updatedAt', label: 'Updated At', visible: false, order: 31 },
