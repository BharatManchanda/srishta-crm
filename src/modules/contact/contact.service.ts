      ...
      data: {
        ...
        columns: {
          create: [
            ...
            {
              field: 'mailingAddress.stateProvince',
              label: 'Mailing State',
              visible: false,
              order: 17,
            },
            ...
            {
              field: 'mailingAddress.streetAddress',
              label: 'Mailing Address',
              visible: false,
              order: 19,
            },
            {
              field: 'otherAddress.country',
              label: 'Other Country',
              visible: false,
              order: 20,
            },
            {
              field: 'otherAddress.city',
              label: 'Other City',
              visible: false,
              order: 21,
            },
            {
              field: 'otherAddress.stateProvince',
              label: 'Other State',
              visible: false,
              order: 22,
            },
            {
              field: 'otherAddress.postalCode',
