...
export class ContactFilterBuilder {
    build(dto: ContactFilterDto) {
        ...
        return {
            ...
            dateOfBirth: PrismaFilter.dateRange(dto.dateOfBirthFrom, dto.dateOfBirthTo),
            ...
            mailingAddress: Object.values(mailingAddress).some(Boolean) ? mailingAddress : undefined,
            otherAddress: Object.values(otherAddress).some(Boolean) ? otherAddress : undefined,
        };
    }
}